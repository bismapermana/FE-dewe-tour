        ...
        <div className="containerProfile">
          <Row>
            <Col className="ml-3">
              ...
              <p className="text-desc ">{trip.countries?.name}</p>
            </Col>
          </Row>
          <Row>
            <Col>
              <Image src="" rounded className="image-content" />
            </Col>
          </Row>
          <Row>
            <div className="container-thumbnail">
              <Image src="" rounded className="image-thumbnail" />
              <Image src="" rounded className="image-thumbnail" />
